...
def build_relay_command_manifest() -> List[Dict[str, Any]]:
    ...
    return [
        ...
        {"name": "reset", "description": "Reset your Robo session"},
        {
            "name": "model",
        ...
        {"name": "status", "description": "Show Robo session status"},
        {"name": "sethome", "description": "Set this chat as the home channel"},
        {"name": "stop", "description": "Stop the running Robo agent"},
        {
            "name": "steer",
        ...
        {"name": "update", "description": "Update Robo Agent to the latest version"},
        {"name": "restart", "description": "Gracefully restart the Robo gateway"},
        {
            "name": "approve",
        ...
        {
            "name": "thread",
            "description": "Create a new thread and start a Robo session in it",
