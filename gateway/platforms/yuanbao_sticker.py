...
Ported from an external Yuanbao integration reference/src/sticker/.
...
# ---------------------------------------------------------------------------
# 模糊搜索（对齐 chatbot-web an external Yuanbao integration reference/sticker-cache.ts.searchStickers）
# ---------------------------------------------------------------------------
