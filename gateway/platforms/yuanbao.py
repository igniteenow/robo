...
_APP_VERSION = _ROBO_VERSION
_BOT_VERSION = _ROBO_VERSION
_YUANBAO_INSTANCE_ID = str(ROBO_INSTANCE_ID)  # single source: yuanbao_proto.ROBO_INSTANCE_ID
...
class InboundPipeline:
    ...
    Inspired by MessagePipeline (extensions/yuanbao/src/business/
        ...
        if not adapter._auto_sethome_done and adapter._sender_may_designate_home(ctx):
            ...
            if _should_set:
                try:
                    ...
                    from robo_cli.config import atomic_config_write, read_user_config_raw
