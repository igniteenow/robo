...
def expand_whatsapp_aliases(identifier: str) -> Set[str]:
    ...
    bridge's ``$ROBO_HOME/whatsapp/session/lid-mapping-*.json`` files,
    ...
    session_dir = get_robo_dir("platforms/whatsapp/session", "whatsapp/session")
