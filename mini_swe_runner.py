#!/usr/bin/env python3
"""
SWE Runner with Robo Trajectory Format

A runner that uses robo-engineer's built-in execution environments
(local, docker, modal) and outputs trajectories in the robo-engineer format
compatible with batch_runner.py and trajectory_compressor.py.

Features:
- Uses robo-engineer's Docker, Modal, or Local environments for command execution
- Outputs trajectories in Robo format (from/value pairs with <tool_call>/<tool_response> XML)
...
# ============================================================================
# Terminal Tool Definition (matches robo-engineer format)
# ============================================================================
...
def create_environment(
    ...
    **kwargs
    ...
    """
    Create an execution environment using robo-engineer's built-in backends.
...
# ============================================================================
# Mini-SWE Runner with Robo Trajectory Format
# ============================================================================

class MiniSWERunner:
    """
    Agent runner that uses robo-engineer's built-in execution environments
    and outputs trajectories in robo-engineer format.
    """
    ...
    def _convert_to_robo_format(
        ...
        """
        Convert internal message format to Robo trajectory format.
...
Complete the user's task step by step."""
        ...
        # Convert to Robo trajectory format
        trajectory = self._convert_to_robo_format(messages, task, completed)
...
def main(
    ...
    """
    Run SWE tasks with Robo trajectory format output.
    ...
    """
    print("🚀 Mini-SWE Runner with Robo Trajectory Format")
    print("=" * 60)
