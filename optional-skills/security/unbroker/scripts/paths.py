...
All per-subject data lives under PDD_DATA_DIR (default: $ROBO_HOME/unbroker),
which is the same trust boundary Robo uses for .env and OAuth tokens.
"""
...
def data_dir() -> Path:
    ...
    return Path(override) if override else robo_home() / "unbroker"
