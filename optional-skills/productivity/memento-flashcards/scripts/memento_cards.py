...
Data file: $ROBO_HOME/skills/productivity/memento-flashcards/data/cards.json
"""
...
_ROBO_HOME = Path(os.environ.get("ROBO_HOME", Path.home() / ".robo"))
DATA_DIR = _ROBO_HOME / "skills" / "productivity" / "memento-flashcards" / "data"
