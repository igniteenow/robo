...
def _state_dir() -> Path:
    ...
    # Default: $ROBO_HOME/watcher-state/, falling back to ~/.robo/watcher-state/.
    robo_home = os.environ.get("ROBO_HOME") or str(Path.home() / ".robo")
    return Path(robo_home) / "watcher-state"
