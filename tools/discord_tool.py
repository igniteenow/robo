...
Only included in the robo-discord toolset, so it has zero cost
...
def _discord_request(
    ...
    req = urllib.request.Request(
        ...
        headers={
            ...
            "User-Agent": "robo-engineer (https://github.com/IgniteeNow/robo-engineer)",
        },
    )
...
def _capability_disk_cache_path() -> "Path":
    ...
    return get_robo_home() / "cache" / "discord_capabilities.json"
