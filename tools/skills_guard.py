...
Trust levels:
  - builtin:   Ships with Robo. Never scanned, always trusted.
...
THREAT_PATTERNS = [
    ...
    (r'\$HOME/\.robo/\.env|\~/\.robo/\.env',
     "robo_env_access", "critical", "exfiltration",
     "directly references Robo secrets file"),
    ...
    (r'\.robo/config\.yaml|\.robo/SOUL\.md',
     "robo_config_mod", "critical", "persistence",
     "references Robo configuration files directly"),
...
# scan. `.skillignore` is the Robo-native name; `.clawhubignore` is honored
