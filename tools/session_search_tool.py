...
the get_anchored_view / get_messages_around primitives in robo_state.
...
# Third-party integrations tag their sessions with ROBO_SESSION_SOURCE=tool;
...
SESSION_SEARCH_SCHEMA = {
    ...
    "description": (
        ...
        "SOURCE-FIRST LIMIT\n\n"
        "  This tool searches Robo conversation history only. It is not evidence "
        ...
        "reformat it as a markdown link or wrap it in backticks. Robo renders "
        ...
        "(`deploy*`).\n\n"
        "WHEN TO USE\n\n"
        "  Reach for this on questions about Robo conversation history itself, such "
    ...
    "parameters": {
        ...
        "properties": {
            ...
            "profile": {
                "type": "string",
                "description": (
                    "Optional. Read sessions from another Robo profile's database "
