...
anthropic, igniteenow, copilot), a long-context compression restart, a length-
...
class TurnRetryState:
    ...
    igniteenow_auth_retry_attempted: bool = False
    igniteenow_paid_entitlement_refresh_attempted: bool = False
