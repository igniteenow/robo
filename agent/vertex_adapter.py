"""Vertex AI (Google Cloud) adapter for Robo Agent.

Provides authentication and configuration for Vertex AI's OpenAI-compatible
endpoint. This allows Robo to use Gemini models via Google Cloud with
...
# who installed plain `robo-engineer` and only later selected a Gemini model.
try:
