...
When a provider returns a non-OK status on a *streaming* request, Robo reads
...
Ported and adapted from an upstream fix ("bound Anthropic error
streams"), generalized to cover Robo's three streaming error-body sites
