...
def build_turn_context(
    ...
    *,
    ...
    # Tag log records on this thread with the session ID for ``robo logs``.
    ...
    if agent.compression_enabled and _should_run_preflight_estimate(
        ...
        # Robo only initiates compaction in "robo" mode (#36801).
        _codex_native_auto = (
        ...
        if _preflight_deferred:
            ...
            logger.info(
                "Skipping Robo preflight compression for codex app-server "
                "(mode=%s); Robo will not start thread compaction here.",
