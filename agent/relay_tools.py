"""Core NeMo Relay adapter for Robo tool execution."""
    ...
    try:
        ...
        if (
            ...
            logger.warning(
                ...
                "returning the Robo tool result",
                exc_info=True,
            )
...
def _run_awaitable(value: Any) -> Any:
    ...
    raise RuntimeError(
        "Synchronous Robo Relay tool execution cannot run on an active event-loop thread"
    )
