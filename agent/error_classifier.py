...
# case: a stream dies mid-response and Robo persists a content-less
...
def _classify_by_status(
    ...
    *,
    ...
    if status_code == 401:
        ...
        # provider-specific refresh (Codex, Anthropic, Ignitee Now) run before
    ...
    if status_code == 404:
        # Ignitee Now API currently surfaces HA/NAS credit depletion as a paid model
...
def _classify_402(error_msg: str, result_fn) -> ClassifiedError:
    ...
    The key insight from prior analysis: some 402s are transient rate limits
