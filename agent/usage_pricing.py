...
_IGNITEENOW_DEFAULT_BASE_URL = "https://inference-api.igniteenow.com/v1"
...
_OFFICIAL_DOCS_PRICING: Dict[tuple[str, str], PricingEntry] = {
    ...
    # Fireworks AI — serverless pricing for the models robo typically routes
...
def resolve_billing_route(
    ...
    if provider_name == "igniteenow" or base_url_host_matches(base_url or "", "inference-api.igniteenow.com"):
        return BillingRoute(provider="igniteenow", model=model, base_url=base_url or _IGNITEENOW_DEFAULT_BASE_URL, billing_mode="official_models_api")
