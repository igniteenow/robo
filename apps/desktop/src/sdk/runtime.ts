 ...
 * plugins resolve `@robo/plugin-sdk` through the vite alias; RUNTIME-loaded
...
const GLOBALS = {
  __ROBO_PLUGIN_SDK__: sdk,
  __ROBO_REACT__: React,
  __ROBO_REACT_JSX__: jsxRuntime,
  __ROBO_REACT_JSX_DEV__: jsxDevRuntime
} as const
...
export function sdkImportMap(): Record<string, string> {
  cached ??= {
    '@robo/plugin-sdk': shimUrl('__ROBO_PLUGIN_SDK__'),
    'react/jsx-dev-runtime': shimUrl('__ROBO_REACT_JSX_DEV__'),
    'react/jsx-runtime': shimUrl('__ROBO_REACT_JSX__'),
    react: shimUrl('__ROBO_REACT__')
  }
