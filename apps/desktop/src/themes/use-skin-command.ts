...
import { RENAMED_SKINS } from './presets'
...
export function useSkinCommand() {
  ...
  return useCallback(
    (rawArg: string) => {
      ...
      // Terminal skin names and retired theme names land on the matching desktop theme.
      const targetName = RENAMED_SKINS[normalized] || normalized
