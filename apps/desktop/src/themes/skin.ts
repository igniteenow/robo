/**
 * Robo skin → DesktopTheme converter.
 *
 * A "skin" is the CLI/TUI theme unit: a YAML file in `$ROBO_HOME/skins/` (or a
 * built-in) resolved by `robo_cli/skin_engine.py` and pushed to every surface
 ...
 * skin Robo authors from a prompt lights up all three surfaces from one file.
 *
...
import type { RoboSkin, SkinColors } from '@robo/shared/skin'
 ...
 */
export function skinToDesktopTheme(skin: RoboSkin): DesktopTheme | null {
