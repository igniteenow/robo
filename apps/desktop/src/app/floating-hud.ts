...
// hairline `--stroke-igniteenow` paired with the soft `--shadow-igniteenow` float.
...
export const HUD_SURFACE =
  'rounded-xl border border-(--stroke-igniteenow) bg-(--ui-chat-bubble-background) shadow-igniteenow [-webkit-app-region:no-drag]'
