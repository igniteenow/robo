...
import { getRoboConfigRecord, listAllProfileSessions } from '@/robo'
...
// Robo session ids: <YYYYMMDD>_<HHMMSS>_<6 hex>. Used to offer a direct
...
function CommandPaletteBody({ onExited }: { onExited: () => void }) {
        ...
        : []),
      {
        ...
        items: [
          ...
          },
          {
            ...
            icon: Download,
            id: 'cc-update-robo',
            keywords: ['update', 'upgrade', 'robo', 'version', 'system', 'restart'],
            label: cc.updateRobo,
  ...
  const searchGroups = useMemo<PaletteGroup[]>(() => {
    ...
    // Apply a theme directly from the root search (e.g. "igniteenow" → Ignitee Now). Live
