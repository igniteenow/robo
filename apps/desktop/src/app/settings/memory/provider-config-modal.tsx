...
import { saveMemoryProviderConfig } from '@/robo'
import { notify, notifyError } from '@/store/notifications'
import { $activeGatewayProfile } from '@/store/profile'
import type { MemoryProviderConfig, MemoryProviderField } from '@/types/robo'
          ...
          {config.docs_url && (
            <a
              ...
              onClick={event => {
                ...
                void window.roboDesktop?.openExternal?.(config.docs_url)
              }}
              rel="noreferrer"
              target="_blank"
            >
