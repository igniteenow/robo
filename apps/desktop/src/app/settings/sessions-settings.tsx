...
import type { RoboConfigRecord, SessionInfo } from '@/types/robo'
...
// / Program Files), which buried any files Robo wrote there.
function DefaultProjectDirSetting() {
  ...
  useEffect(() => {
    ...
    // / Storybook / non-Electron context `window.roboDesktop` is
    ...
    const settings = window.roboDesktop?.settings
