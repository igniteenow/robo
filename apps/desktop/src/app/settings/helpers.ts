...
import type { ConfigFieldSchema, RoboConfigRecord, ToolsetInfo } from '@/types/robo'
...
export function getNested(obj: RoboConfigRecord, path: string): unknown {
  let cur: unknown = obj
...
export function setNested(obj: RoboConfigRecord, path: string, value: unknown): RoboConfigRecord {
...
function personalityOptions(config: RoboConfigRecord): string[] {
...
function commandProviderNames(config: RoboConfigRecord, section: 'tts' | 'stt'): string[] {
