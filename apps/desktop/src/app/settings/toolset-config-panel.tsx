 ...
 * server-computed `status` (keys ∧ post-setup install
 ...
 * log inline — the GUI equivalent of the install step `robo tools` runs
...
/**
 * Backend model catalog — the GUI counterpart of the model picker `robo
