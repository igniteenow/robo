...
vi.mock('@/robo', () => ({
  saveRoboConfig: (config: Record<string, unknown>) => mocks.save(config)
}))
...
vi.mock('../hooks/use-config-record', () => ({
  setRoboConfigCache: (config: Record<string, unknown>) => mocks.cache(config),
  useRoboConfigRecord: () => ({ data: mocks.loadedConfig })
}))
