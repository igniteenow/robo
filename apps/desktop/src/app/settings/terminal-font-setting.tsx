...
import { saveRoboConfig } from '@/robo'
...
function fontFamilyFromConfig(config: RoboConfigRecord): string {
...
export function TerminalFontSetting() {
  ...
  const { data: loadedConfig } = useRoboConfigRecord()
  ...
  const [staleConfig, setStaleConfig] = useState<RoboConfigRecord | null>(null)
  ...
  useEffect(() => {
    ...
    // holds — successful saves write it back via setRoboConfigCache, so
        ...
        <div className="mt-3 space-y-2">
          <div className="flex items-center gap-3">
            <Input
              ...
              className="flex-1"
              disabled={draft === null}
              list="robo-terminal-font-families"
          ...
          <datalist id="robo-terminal-font-families">
