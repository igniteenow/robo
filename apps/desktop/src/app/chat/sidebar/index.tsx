...
import { searchSessions, type SessionInfo, type SessionSearchResult } from '@/robo'
...
export function ChatSidebar({
  ...
  useEffect(() => {
    ...
    window.addEventListener('robo:new-session-shortcut', onShortcut)

    return () => {
      window.removeEventListener('robo:new-session-shortcut', onShortcut)
      clearTimeout(timeout)
    }
  }, [])
  ...
  // A turn can `git worktree add/remove` in the terminal (e.g. you ask Robo to
