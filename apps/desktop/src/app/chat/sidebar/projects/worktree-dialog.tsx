...
const branchActionLabel = (branch: RoboGitBranch, copy: BranchActionCopy) => {
...
export function WorktreeDialog() {
  ...
  const [branches, setBranches] = useState<RoboGitBranch[]>([])
  ...
  const convert = async (branch: RoboGitBranch) => {
    if (pending || !repoPath || !branch) {
      return
    }
