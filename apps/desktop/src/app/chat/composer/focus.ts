...
const FOCUS_EVENT = 'robo:composer-focus'
const INSERT_EVENT = 'robo:composer-insert'
const INSERT_REFS_EVENT = 'robo:composer-insert-refs'
const SUBMIT_EVENT = 'robo:composer-submit'
const VOICE_TOGGLE_EVENT = 'robo:composer-voice-toggle'
const MODEL_MENU_EVENT = 'robo:composer-model-menu'
