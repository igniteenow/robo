...
describe('pathifyRefs', () => {
  ...
  it('leaves a handle alone', () => {
    expect(pathifyRefs('cc @robodev1 on this')).toBe('cc @robodev1 on this')
  })
  ...
  it('leaves an email alone', () => {
    expect(pathifyRefs('mail me at brooklyn@igniteenow.dev/x')).toBe('mail me at brooklyn@igniteenow.dev/x')
  })
...
describe('chipTypedPathOnSpace', () => {
  ...
  it('leaves a handle alone', () => {
    const { editor, event } = spaceOn('cc @robodev1')
