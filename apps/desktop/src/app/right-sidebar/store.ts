...
const TAKEOVER_KEY = 'robo.desktop.terminalTakeover'
 ...
 *  (CLI-managed) providers, which Robo can't clear via the API — the user
 *  sees exactly what runs instead of Robo silently deleting their creds. */
