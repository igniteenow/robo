import type { RoboReviewFile } from '@/global'
...
export function buildReviewFlatList(files: RoboReviewFile[]): ReviewTreeNode[] {
  return [...files]
...
export function buildReviewTree(files: RoboReviewFile[], compact = true): ReviewTreeNode[] {
  const root = makeDir('', '')
