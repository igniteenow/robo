...
const POPOUT_STORAGE_KEY = 'robo.desktop.composerPopout.zones.v1'
...
const LEGACY_ENABLED_KEY = 'robo.desktop.composerPopout.enabled'
const LEGACY_POSITION_KEY = 'robo.desktop.composerPopout.position'
