...
export interface PetInfo {
  ...
  // the Robo "run" activity state uses the in-place running row).
 ...
 * ROBO_HOME — so every pet RPC carries this. The gateway no-ops it for the
 ...
 */
const ROAM_KEY = 'robo.desktop.pet-roam.v1'
