...
const TILES_KEY = 'robo.desktop.sessionTiles.v2'
const LEGACY_TILES_KEY = 'robo.desktop.sessionTiles.v1'
...
if ((import.meta.env.DEV || import.meta.env.VITE_PERF_PROBE === '1') && typeof window !== 'undefined') {
  ;(window as unknown as Record<string, unknown>).__ROBO_SESSION_TILES__ = {
