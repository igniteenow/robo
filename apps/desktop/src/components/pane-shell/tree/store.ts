...
const STORAGE_KEY = 'robo.desktop.layoutTree.v2'

writeKey('robo.desktop.layoutTree.v1', null)
 ...
 */
export const $activePresetId = atom<string>(readKey('robo.desktop.layoutPreset.active') ?? 'default')

export function markActivePreset(id: string) {
  $activePresetId.set(id)
  writeKey('robo.desktop.layoutPreset.active', id)
}
 ...
 */
const DISMISSED_KEY = 'robo.desktop.dismissedPanes.v1'
...
const USER_PLACED_KEY = 'robo.desktop.userPlacedPanes.v1'
...
if ((import.meta.env.DEV || import.meta.env.VITE_PERF_PROBE === '1') && typeof window !== 'undefined') {
  ;(window as unknown as Record<string, unknown>).__ROBO_LAYOUT_TREE__ = {
    close: closeTreePane,
