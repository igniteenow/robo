...
const FALLBACK_COPY: IntroCopy[] = [
  ...
  {
    headline: 'What should Robo look at?',
...
function fallbackCopyForPersonality(personalityKey: string): IntroCopy[] {
  ...
  return [
    ...
    {
      headline: `What does ${label} Robo need to see?`,
    ...
    {
      headline: `What should ${label} Robo tackle?`,
  ...
  return (
    ...
    >
      <div className="w-full min-w-0">
        <RoboLiveFace className="mx-auto mb-5 h-48 w-48 rounded-[32px] shadow-2xl" />
        <p
          aria-label={WORDMARK}
          className="fit-text mx-auto mb-1 w-[calc(100%-1rem)] font-['Poppins'] font-bold uppercase leading-[0.9] tracking-[0.08em] text-midground mix-blend-plus-lighter dark:text-foreground/90"
