...
import type { ModelOptionProvider, ModelPricing } from '@/types/robo'
...
export function ModelPickerDialog({
  ...
  // the `robo model` CLI picker, which shows the curated list verbatim.
...
function ProviderHeading({ provider }: { provider: ModelOptionProvider }) {
  ...
  // free_tier is reserved and always null on current backends. true → "Free tier", false → "Pro".
  const tierBadge =
