...
// shape is fixable from Settings → Gateway (edit URL / token / sign in) —
// the local Retry/Repair buttons target the bundled backend and can't help.
// Drives the escape-hatch emphasis.
