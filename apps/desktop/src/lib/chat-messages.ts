...
import { type BillingBlock, skillInvocationText } from '@robo/shared'
...
import type { MessageReaction, SessionMessage, UsageStats } from '@/types/robo'
...
export type GatewayEventPayload = {
  ...
  // with FailoverReason.billing (shape mirrors @robo/shared BillingBlock).
