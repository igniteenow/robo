...
const SKIP_PROTO_RE = /^(?:file|data|mailto|javascript|blob|chrome|about|robo):/i
...
export function fetchLinkTitle(url: string): Promise<string> {
  ...
  const bridge = typeof window === 'undefined' ? undefined : window.roboDesktop?.fetchLinkTitle
...
export function openExternalLink(href: string): void {
  if (href) {
    void window.roboDesktop?.openExternal?.(href)
  }
}
