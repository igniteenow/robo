...
describe('displayPath', () => {
  it('collapses a macOS home prefix to ~', () => {
    expect(displayPath('/Users/brooklyn/www/robo-engineer')).toBe('~/www/robo-engineer')
...
describe('pathLeaf', () => {
  it('returns the last segment', () => {
    expect(pathLeaf('/Users/me/www/robo-engineer')).toBe('robo-engineer')
    expect(pathLeaf('~/www/robo-engineer')).toBe('robo-engineer')
