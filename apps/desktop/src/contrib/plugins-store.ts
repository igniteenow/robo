 ...
 * `<robo home>/desktop-plugins/*` disk door — incl. agent-written ones),
...
const DECISIONS_KEY = 'robo.desktop.pluginDecisions.v2'
const LEGACY_DISABLED_KEY = 'robo.desktop.disabledPlugins.v1'
