...
export const en: Translations = {
  ...
  boot: {
    ...
    steps: {
      ...
      loadingSettings: 'Loading Robo settings',
      loadingSessions: 'Loading recent sessions',
      startingDesktopConnection: 'Starting desktop connection',
      startingRoboDesktop: 'Starting Robo…'
    },
    errors: {
      backgroundExited: 'Robo background process exited.',
      backgroundExitedDuringStartup: 'Robo background process exited during startup.',
  ...
  notifications: {
    ...
    backendOutOfDateMessage:
      'Your Robo backend is older than this desktop build and may not work correctly. Update to align them.',
    installMethodUnsupportedTitle: 'Unsupported install method',
    updateRobo: 'Update Robo',
    ...
    errors: {
      ...
      methodNotAllowed:
        'The desktop backend rejected that request (405 Method Not Allowed). Try restarting Robo.',
    ...
    native: {
      ...
      inputBody: 'Robo is waiting for your response.',
      turnDoneTitle: 'Robo finished',
      turnDoneBody: '',
  ...
  settings: {
    ...
    resetConfirm: 'Reset all settings to Robo defaults?',
    ...
    notifications: {
      ...
      focusedHint: 'Completion alerts only fire while Robo is in the background.',
      kinds: {
        approval: {
        ...
        input: {
          label: 'Input needed',
          description: 'Robo asked a question or needs a password or secret.'
        },
        turnDone: {
          label: 'Response ready',
          description: 'A turn finished while Robo was in the background.'
        },
        turnError: {
          label: 'Turn failed',
        ...
        plugin: {
          ...
          description: 'A desktop plugin sent a notification while Robo was in the background.'
        }
      },
    ...
    appearance: {
      ...
      colorModeDesc: 'Pick a fixed mode or let Robo follow your system setting.',
      ...
      reactionsDesc: 'iMessage-style emoji tapbacks — react to messages, and Robo can react to yours.',
      ...
      pet: {
        title: 'Pet',
        intro:
          'Adopt an animated petdex mascot that floats over the app and reacts to what Robo is doing — running while tools execute, celebrating on success, sulking on errors.',
        restartHint:
          'Pets need a quick restart — the running app started before this feature was added. Quit and reopen Robo, then come back here.',
        on: 'On',
        off: 'Off',
        scaleTitle: 'Size',
    ...
    about: {
      ...
      automaticUpdatesDesc:
        'Robo checks for updates automatically in the background and lets you know when one is ready.',
    ...
    config: {
      ...
      loading: 'Loading Robo configuration...',
    ...
    quickEntry: {
      ...
      enabledDesc:
        'Summon a small composer from anywhere with a global shortcut and fire a prompt without opening Robo.',
    ...
    gateway: {
      ...
      intro:
        'Local by default. Use remote when this app should drive a Robo backend elsewhere. Per-profile overrides below.',
      ...
      envOverrideDesc:
        'Unset ROBO_DESKTOP_REMOTE_URL and ROBO_DESKTOP_REMOTE_TOKEN to use the saved setting below.',
      modeTitle: 'Connection mode',
      localTitle: 'Local gateway',
      localDesc: 'Start a private Robo backend on localhost. This is the default and works offline.',
      inheritTitle: 'Use default gateway',
      inheritDesc: "Remove this profile's override and use the default connection.",
      remoteTitle: 'Remote gateway',
      remoteDesc: 'Connect this desktop shell to a remote Robo backend.',
      ...
      remoteUrlDesc: 'Base URL for the remote dashboard backend. Path prefixes are supported, for example /robo.',
      ...
      restartingMessage: 'Robo will reconnect using the saved settings — the shell stays open.',
      savedMessage: 'Saved for the next restart.',
      connectedTo: (baseUrl, version) => `Connected to ${baseUrl}${version ? ` · Robo ${version}` : ''}`,
      ...
      sshDesc:
        'Robo is launched on the remote over SSH and tunneled to this app — nothing to start or expose yourself. Requires working key-based SSH access to the host.',
      ...
      sshRoboPathTitle: 'Robo path (optional)',
      sshRoboPathDesc: 'Full path to the remote Robo binary. Blank = auto-detect Robo or a compatible runtime.',
      sshRoboPathPlaceholder: 'auto-detect',
      ...
      sshReachable: (host, platform) => `Reachable: ${host} (${platform}) — Robo found`,
      ...
      sshErrAuth:
        'SSH authentication failed. Load your key into the ssh-agent (ssh-add) or set an IdentityFile in ~/.ssh/config — Robo runs ssh non-interactively.',
      sshErrHostKey:
        'The host key has CHANGED since you last connected. Verify this is expected, then run ssh-keygen -R <host> and reconnect.',
      sshErrNotInstalled:
        'Robo is not installed on the remote host. Install the matching Robo release package there or set the Robo path.',
      sshErrPlatform:
        'Unsupported remote platform. Robo SSH mode supports Linux, macOS, and Windows remote hosts.',
      sshErrTimeout: 'SSH connection timed out. The host may be unreachable or asleep.',
      sshErrUpdateRequired: 'Update Robo on the remote host before connecting with Desktop SSH.',
    ...
    providers: {
      ...
      localEndpoint: {
        ...
        description: 'Point Robo at any OpenAI-compatible endpoint (Zyphra, vLLM, llama.cpp, Ollama, etc).'
      },
  ...
  skills: {
    ...
    skillArchivedMessage: 'Restorable via robo curator restore.',
    hub: {
  ...
  starmap: {
    ...
    emptyDesc: 'As Robo builds skills and memories for your work, they appear here.',
    share: 'Share map',
    shareHint:
  ...
  commandCenter: {
    ...
    pets: {
      ...
      staleBackend: 'Restart Robo to use pets — the backend predates this feature.',
    ...
    generatePet: {
      ...
      staleBackend: 'Update Robo to generate pets.',
      backgroundHint: 'You can close this — Robo will notify you when it’s done.',
    ...
    nav: {
      ...
      settings: { title: 'Settings', detail: 'Configure Robo desktop' },
    ...
    roboActiveSessions: (version, count) => `Robo ${version} · Active sessions ${count}`,
  ...
  messaging: {
    ...
    fieldCopy: {
      ...
      MATRIX_USER_ID: { label: 'Bot user ID', placeholder: '@robo:example.org' },
  ...
  profiles: {
    ...
    deleting: 'Deleting...',
    createDesc: 'Profiles are independent Robo environments: separate config, skills, and SOUL.md.',
    nameLabel: 'Name',
  ...
  cron: {
    ...
    newCron: 'New cron',
    emptyDescNew:
      'Schedule a prompt to run on a cron expression. Robo will run it and deliver results to the destination you pick.',
  ...
  sidebar: {
    ...
    projects: {
      ...
      staleBackend:
        'Update the Robo backend to create projects — your backend is older than this desktop app (Settings → Updates → Backend).',
      deleteConfirm: 'This removes the saved project from Robo. Files, git repos, and worktrees stay untouched.',
  ...
  composer: {
    ...
    attachUrlDesc: 'Robo will fetch the page and include it as context for this turn.',
  ...
  updates: {
    stages: {
      ...
      pull: 'Almost there…',
      pydeps: 'Finishing up…',
      update: 'Updating Robo…',
      rebuild: 'Rebuilding the desktop app…',
      restart: 'Restarting Robo…',
    ...
    unsupportedMessage: 'This version of Robo can’t update itself from inside the app.',
    ...
    guiSkewBody:
      'The backend was updated, but this desktop app package wasn’t changed. Update or reinstall the Robo desktop app (your AppImage / .deb / .rpm) to match.',
    copy: 'Copy',
    copied: 'Copied',
    done: 'Done',
    applyingBody:
      'The Robo updater takes over in its own window and reopens Robo automatically when it’s done. Please don’t reopen Robo yourself while it’s updating.',
    applyingBodyBackend:
      'The remote backend is applying the update and will restart. Robo reconnects automatically when it’s back.',
    applyingClose: 'This window will close while the update runs, then Robo reopens on its own.',
  ...
  install: {
    ...
    oneTimeTitle: 'Robo needs a one-time install',
    ...
    setupChoiceTitle: 'Set up Robo',
    setupChoiceDesc:
      'Connect this app to a Robo gateway you already run, or install Robo locally on this computer.',
    connectExistingTitle: 'Connect to existing Robo',
    ...
    installLocalTitle: 'Install Robo locally',
    installLocalDesc: 'Download Robo, create its Python environment, and run the backend on this computer.',
    localStartUnavailable: 'Local installation could not start. Restart Robo and try again.',
    remoteSetupTitle: 'Connect to existing Robo',
    remoteSetupDesc: 'Enter your gateway URL. Robo will detect whether it needs a token or browser sign-in.',
    remoteUrlTitle: 'Gateway URL',
    remoteUrlDesc: 'Use the base URL of the Robo gateway, including https:// when remote.',
    remoteUrlPlaceholder: 'https://gateway.example.com/robo',
    probing: 'Detecting gateway authentication...',
    probeError: 'Could not reach that Robo gateway.',
    identityProvider: 'your identity provider',
    authTitle: 'Authentication',
    ...
    settingUpTitle: 'Setting up Robo Agent',
    finishingTitle: 'Finishing up',
    failedDesc:
      'One of the install steps failed. On Windows, this can happen if another Robo CLI or desktop instance is running. Stop any running Robo instances, then retry. Check the details below or the desktop log for the full transcript.',
    activeDesc:
  ...
  onboarding: {
    headerTitle: "Let's get you setup with Robo Agent",
    headerDesc: 'Connect a model provider to start chatting. Most options take one click.',
    preparingInstall: 'Robo is finishing install. This usually takes under a minute on first run.',
    starting: 'Starting Robo…',
    ...
    apiKeyOptions: {
      ...
      local: {
        short: 'self-hosted',
        description: 'Point Robo at a local or self-hosted OpenAI-compatible endpoint (vLLM, llama.cpp, Ollama, etc).'
      }
    },
    ...
    flowSubtitles: {
      ...
      device_code: 'Opens a verification page in your browser — Robo connects automatically',
    ...
    authorizeThere: 'Authorize Robo there.',
    ...
    autoBrowser: provider =>
      `We opened ${provider} in your browser. Authorize Robo there and you'll be connected automatically — nothing to copy or paste.`,
  ...
  preview: {
    ...
    largeBody: (label, size) => `${label} is ${size}. Robo will only show the first 512 KB.`,
    ...
    web: {
      ...
      tryAgain: 'Try again',
      restarting: 'Robo is restarting...',
      askRestart: 'Ask Robo to restart the server',
      lookingRestart: taskId => `Robo is looking for a preview server to restart (${taskId})`,
      restartingTitle: 'Restarting preview server',
      restartingMessage: 'Robo is working in the background. Watch the preview console for progress.',
      ...
      finishedRestarting: message => `Robo finished restarting the preview server${message ? `: ${message}` : ''}`,
      ...
      restartFailedMessage: 'Robo could not restart the server.',
      stillWorking:
        'Robo is still working, but no restart result has arrived yet. The server command may be running in the foreground.',
  ...
  assistant: {
    thread: {
      ...
      loadingResponse: 'Robo is loading a response',
    ...
    approval: {
      gatewayDisconnected: 'Robo gateway is not connected',
      ...
      alwaysDescription: pattern =>
        `This adds the “${pattern}” pattern to your permanent allowlist (~/.robo/config.yaml). Robo won’t ask again for commands like this — in this session or any future one.`,
  ...
  prompts: {
    ...
    sudoDesc: 'Robo needs your sudo password to run a privileged command. It is sent only to your local agent.',
    sudoPlaceholder: 'sudo password',
    secretTitle: 'Secret required',
    secretDesc: 'Robo needs a credential to continue.',
  ...
  desktop: {
    ...
    restartToUseSaveImage: 'Restart Robo to use Save Image.',
    restartToSaveImages: 'Restart Robo to save images',
    ...
    handoff: {
      ...
      timedOut: 'Timed out waiting for the gateway. Is `robo gateway` running?'
    }
  },
