...
export interface Translations {
  ...
  settings: {
    ...
    gateway: {
      ...
      sshKeyTitle: string
      sshKeyDesc: string
      sshRoboPathTitle: string
      sshRoboPathDesc: string
      sshRoboPathPlaceholder: string
  ...
  commandCenter: {
    ...
    roboActiveSessions: (version: string, count: number) => string
