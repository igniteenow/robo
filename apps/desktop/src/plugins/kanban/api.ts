...
import { atom, type PluginRestOptions, type PluginStorage, queryClient } from '@robo/plugin-sdk'
...
/** First-class Robo projects, for scoping a board's default workspace. */
