 ...
 * `src/plugins/` with a `plugin.tsx` that default-exports a `RoboPlugin` is
 ...
 *
 * The ONLY import surface is `@robo/plugin-sdk` (lint-enforced) — the
