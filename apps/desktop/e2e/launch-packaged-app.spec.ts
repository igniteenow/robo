...
/**
 * E2E smoke tests for the packaged Robo desktop app.
 *
 ...
 * (credential stripping, isolated ROBO_HOME + userData, unique app name).
 *
...
test('window opens with the Robo title', async () => {
