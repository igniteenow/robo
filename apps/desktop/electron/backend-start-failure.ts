 ...
 * startRobo() re-throw the cached error without re-attempting the connect —
...
/**
 * Whether a startRobo() failure should latch into `backendStartFailure`.
 ...
 * Every subsequent `getConnection`/`api` call re-runs `startRobo`, re-emits
