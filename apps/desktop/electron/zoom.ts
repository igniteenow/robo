...
export const ZOOM_STORAGE_KEY = 'robo:desktop:zoomLevel'
 ...
 * but forgot to emit 'robo:zoom:changed', leaving the control stuck at 100%.
...
export function applyZoomLevel(webContents, level) {
  ...
  webContents.send('robo:zoom:changed', { level: clamped, percent: zoomLevelToPercent(clamped) })
