...
// by main.ts (`setBackgroundThrottling` driven by the merged `robo:active-work`
...
// (the "Robo idles at 20% CPU while minimized" bug). The preload path is
...
// conversation started by the "Hey Robo" wake word has NO preceding click,
