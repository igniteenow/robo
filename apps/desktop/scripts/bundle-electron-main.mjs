...
// so ROBO_DESKTOP_DEV_SERVER / source-tree resolution keep working.
const isDev = process.argv.includes('--dev')
const define = isDev
  ? {}
  : { 'process.env.ROBO_DESKTOP_IS_PACKAGED': JSON.stringify(true) }

// Resolve entries from the desktop workspace and keep package paths on their
// logical workspace mount. This makes Windows builds reliable from subst
// drives, junction-backed dependency caches, and long source paths.
