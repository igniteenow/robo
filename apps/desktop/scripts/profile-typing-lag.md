...
cd apps/desktop
XCURSOR_SIZE=24 ROBO_DESKTOP_DEV_SERVER=http://127.0.0.1:5174 \
...
node apps/desktop/scripts/profile-typing.mjs \
  --chars=400 --cps=30 --out=/tmp/robo-typing
# → /tmp/robo-typing.cpuprofile  (open in Chrome DevTools Performance)
# → /tmp/robo-typing.before.heapsnapshot
# → /tmp/robo-typing.after.heapsnapshot
```
