...
export default defineConfig(({ command }) => ({
  ...
  css: {
    ...
    // `C:\Users\<name>\AppData\Local\robo\robo-engineer\apps\desktop`), so an
  ...
  resolve: {
    alias: {
      ...
      '@robo/plugin-sdk': path.resolve(__dirname, './src/sdk/index.ts'),
      '@robo/shared/billing': path.resolve(__dirname, '../shared/src/billing-types.ts'),
      '@robo/shared': path.resolve(__dirname, '../shared/src'),
