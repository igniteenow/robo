/**
 * Canonical Robo skin — the theme SDK's cross-surface contract.
 *
 * A skin is authored once as YAML in `$ROBO_HOME/skins/<name>.yaml` (or a
 * built-in), resolved by the Python skin engine (`robo_cli/skin_engine.py`),
 ...
 *   • CLI     → `robo_cli/skin_engine` → prompt_toolkit / Rich styles (Python)
 *
