# Robo Achievements Performance Implementation Plan
...
- Snapshot persisted at `~/.robo/plugins/robo-achievements/scan_snapshot.json`.
...
Acceptance:
- Checkpoint persisted at `~/.robo/plugins/robo-achievements/scan_checkpoint.json`.
