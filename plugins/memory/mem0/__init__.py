...
Configuration
-------------
Secret (lives in $ROBO_HOME/.env or the environment):
...
Behavioral settings (live in $ROBO_HOME/mem0.json, set via `robo memory
setup`):
  ...
  agent_id           — Agent identifier (default: robo)
...
def _load_config() -> dict:
    """Load config from env vars, with $ROBO_HOME/mem0.json overrides.
    ...
    config = {
        ...
        "agent_id": os.environ.get("MEM0_AGENT_ID", "robo"),
        "oss": {},
    }
    ...
    config_path = get_robo_home() / "mem0.json"
...
class Mem0MemoryProvider(MemoryProvider):
    ...
    def save_config(self, values, robo_home):
        """Write config to $ROBO_HOME/mem0.json."""
        import json
    ...
    def initialize(self, session_id: str, **kwargs) -> None:
        ...
        #   1. Operator-configured MEM0_USER_ID (env or $ROBO_HOME/mem0.json) —
        ...
        self._agent_id = self._config.get("agent_id", "robo")
