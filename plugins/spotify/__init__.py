...
``_check_spotify_available()`` — when the user has not run ``robo auth
spotify``, the tools remain registered (so they appear in ``robo
...
The Spotify auth flow (``robo auth spotify``), CLI plumbing, and docs
