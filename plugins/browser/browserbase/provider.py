...
credentials. Managed Ignitee Now gateway support has been removed — the Ignitee Now
...
class BrowserbaseBrowserProvider(BrowserProvider):
    ...
    Direct credentials only — managed-Ignitee Now-gateway support lives on the
    ...
    def create_session(self, task_id: str) -> Dict[str, object]:
        ...
        session_name = f"robo_{task_id}_{uuid.uuid4().hex[:8]}"
