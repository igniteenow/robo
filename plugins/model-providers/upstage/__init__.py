...
# When the user hasn't picked a reasoning effort, Robo passes
...
# ON at this effort — matching the "medium (default)" that Robo' /reasoning
...
class UpstageProfile(ProviderProfile):
    ...
    def build_api_kwargs_extras(
        ...
        # Map Robo' effort vocabulary onto Solar's accepted set. xhigh/max/
