...
# Robo uses 3 abstract aspect ratios. Map to Krea's enum (which is wider).
    ...
    def generate(
        ...
        **kwargs: Any,
        ...
        if not auth_token:
            return error_response(
                error=(
                    "KREA_API_KEY not set. Run `robo tools` → Image "
        ...
        headers = {
            ...
            "User-Agent": "robo-engineer/1.0 (krea-image-gen)",
        }
