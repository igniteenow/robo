...
required — uses aiohttp which is already a Robo dependency.
...
# practical limit for readable messages — matching choice).
...
def interactive_setup() -> None:
    ...
    ``robo_cli/setup.py::_setup_mattermost`` function this migration
    removes.
    """
    ...
    print()
    print_info("📬 Home Channel: where Robo delivers cron job results and notifications.")
...
def register(ctx) -> None:
    ...
    ctx.register_platform(
        ...
        # robo_cli/setup.py::_setup_mattermost function.
