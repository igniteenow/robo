...
Config: ~/.robo/feishu_comment_rules.json (mtime-cached, hot-reload).
Pairing store: ~/.robo/feishu_comment_pairing.json.
"""
...
# ---------------------------------------------------------------------------
#
# Uses the canonical ``get_robo_home()`` helper (ROBO_HOME-aware and
...
RULES_FILE = get_robo_home() / "feishu_comment_rules.json"
PAIRING_FILE = get_robo_home() / "feishu_comment_pairing.json"
