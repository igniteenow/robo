...
class SmsAdapter(BasePlatformAdapter):
    """
    Twilio SMS <-> Robo gateway adapter.

    Each inbound phone number gets its own Robo session (multi-tenant).
...
# static dict in robo_cli/gateway.py, and the _send_sms dispatch in
