...
Reporta de forma privada a través de [GitHub Security Advisories](https://github.com/IgniteeNow/robo-engineer/security/advisories/new)
...
- Detalles del entorno (`robo version`, SHA del commit, SO, versión de Python).
