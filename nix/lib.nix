      ...
      let
        ...
        excludedDirs =
          ...
          jsWorkspaceTopDirs ++ [
            ...
            "nix"
            # Skills are shipped via ROBO_BUNDLED_SKILLS /
            # ROBO_OPTIONAL_SKILLS (see robo-engineer.nix), not via the
            ...
            # __init__.py) shipped via symlinks + ROBO_BUNDLED_LOCALES
            # / ROBO_OPTIONAL_MCPS, not via the wheel. Excluding them
