...
const STORAGE_KEY = "robo-dashboard-theme";
...
const FONT_STORAGE_KEY = "robo-dashboard-font";
...
const THEME_NAME_ALIASES: Record<string, string> = {
  // Legacy names from before the Ignitee identity.
  "lens-5i": "igniteenow-light",
  "igniteenow-blue": "igniteenow-light",
};
 ...
 *  `_THEME_NAMED_ASSET_KEYS` in `robo_cli/web_server.py`. */
...
const CUSTOM_CSS_STYLE_ID = "robo-theme-custom-css";
...
function applyCustomCSS(css: string | undefined) {
  ...
  if (!el) {
    ...
    el.setAttribute("data-robo-theme-css", "true");
...
function injectFontStylesheet(url: string | undefined) {
  ...
  link.rel = "stylesheet";
  link.href = url;
  link.setAttribute("data-robo-theme-font", "true");
...
function applyTheme(theme: DashboardTheme) {
  ...
  // (e.g. Ignitee Light) doesn't leave its values behind when the user
