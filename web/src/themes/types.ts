...
export interface ThemePalette {
  ...
  /** Top-layer highlight. In the default theme this is white @ alpha 0 — invisible by
 ...
 *  `index.css` (soft indigo `#8e8ce0` for input, ember `#ef8a22` for output). */
...
export interface ThemeListEntry {
   ...
   *  `~/.robo/dashboard-themes/*.yaml`; undefined for built-ins (the
