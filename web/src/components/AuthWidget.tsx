 ...
 * OAuth gate (Phase 7 of .robo/plans/2026-05-21-dashboard-oauth-auth.md).
 *
 ...
 *     auth contract V1 doesn't emit email/display_name claims (Contract
 *     Anchor C4 in the plan; the API responds with empty strings for those
...
export function AuthWidget({ className }: AuthWidgetProps) {
  ...
  const gated =
    typeof window !== "undefined" && !!window.__ROBO_AUTH_REQUIRED__;
