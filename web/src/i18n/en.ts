...
export const en: Translations = {
  ...
  status: {
    ...
    updateRoboConfirmMessage:
      "This runs robo update and restarts the gateway when it finishes. Active sessions keep their prompt cache until then.",
    updateRoboConfirmNow: "Update now",
    updateRoboConfirmTitle: "Update Robo?",
    updatingRobo: "Updating Robo…",
  ...
  pluginsPage: {
    ...
    headline:
      "Discover, install, enable, and update Robo plugins (`robo plugins` parity).",
    ...
    removeConfirm: "Remove this plugin from ~/.robo/plugins/?",
    removeHint: "Only user-installed plugins under ~/.robo/plugins can be removed.",
  ...
  skills: {
    ...
    filters: "Filters",
    noSkills: "No skills found. Skills are loaded from ~/.robo/skills/",
  ...
  env: {
    ...
    customHint: "Arbitrary environment variables stored in your .env that Robo doesn't recognise. Use these to inject env vars for skills, MCP servers, or your own tooling.",
  ...
  achievements: {
    hero: {
      ...
      title: "Robo Achievements",
      subtitle:
        "Collectible Robo badges earned from real session history. Known unfinished achievements are shown as Discovered; Secret achievements stay hidden until the first matching behavior appears.",
      scan_subtitle:
        "Scanning Robo session history. First scan can take 5–10 seconds on large histories.",
    },
    actions: {
      rescan: "Rescan",
    },
    stats: {
      ...
      latest: "Latest",
      latest_hint_empty: "run Robo more",
      none_yet: "None yet",
    },
    state: {
      unlocked: "Unlocked",
    ...
    guide: {
      ...
      secret_body:
        "Secrets hide their exact trigger. Once Robo sees a related signal, the card becomes Discovered and shows its requirement.",
      scan_status_header: "Scan status",
      scan_status_body:
        "Robo is scanning local history once, then cards will appear automatically. Nothing is stuck if this takes a few seconds.",
    ...
    share: {
      ...
      tweet_text: "Just unlocked {tier_part}\"{name}\" in Robo Agent ◆",
    },
  },
