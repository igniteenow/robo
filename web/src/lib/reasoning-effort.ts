 ...
 *
 * Values mirror robo_constants.VALID_REASONING_EFFORTS plus `none`
 * (thinking-off). An empty/unset config value means the Robo default,
 * which is `medium`.
 */
 ...
 *  option. Empty/unknown → `medium` (Robo' default when unset). */
