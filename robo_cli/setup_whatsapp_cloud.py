...
Entry point: ``robo whatsapp-cloud`` (dispatched from
``cmd_whatsapp_cloud`` in ``robo_cli/main.py``).
...
Robo gateway and the cloudflared tunnel both run in separate
...
def run_whatsapp_cloud_setup() -> int:
    ...
    print("=" * 50)
    print()
    print("This wizard configures Robo to talk to WhatsApp via Meta's")
    ...
    print("─" * 50)
    print()
    print("  Robo needs a public HTTPS URL to receive WhatsApp messages.")
