"""
Skills configuration for Robo.
`robo skills` enters this module.

Toggle individual skills or categories on/off, globally or per-platform.
Config stored in ~/.robo/config.yaml under:
...
from robo_cli.config import cfg_get, load_config, save_config
from robo_cli.colors import Colors, color
from robo_cli.platforms import PLATFORMS as _PLATFORMS
