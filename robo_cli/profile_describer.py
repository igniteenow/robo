...
Used by ``robo profile describe <name> --auto`` and the dashboard's
...
Design notes
------------
- Mirrors the shape of ``robo_cli/kanban_specify.py``: lazy aux
...
_SYSTEM_PROMPT = """You are a profile-describer for the Robo kanban board.
...
Rules:
  ...
  - Never write "Robo profile" or other meta-narration.
    ...
    *,
    ...
    try:
        if canon == "default":
            ...
            profile_dir = Path(get_robo_home())
        else:
