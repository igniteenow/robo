...
Usage:
    robo pairing list              # Show all pending + approved users
    robo pairing approve <platform> <request-id|code>  # Approve a pairing request
    robo pairing revoke <platform> <user_id> # Revoke user access
...
def pairing_command(args):
    ...
    if action == "list":
        ...
        print("Usage: robo pairing {list|approve|revoke|clear-pending}")
        print("Run 'robo pairing --help' for details.")
...
def _cmd_list(store):
    ...
    if pending:
        ...
        print("\n  Approve with: robo pairing approve <platform> <request-id>")
...
def _cmd_approve(store, platform: str, code: str):
    ...
    if result:
        ...
        print(
            ...
            "~/.robo/platforms/pairing/_rate_limits.json\n".format(platform)
        )
    else:
