"""``robo journey`` — what Robo has learned, on a timeline.
...
def _primary_hex() -> str:
    ...
    try:
        ...
        return skin.get_color("ui_primary", "") or skin.get_color("banner_title", "#EF8A22")
    except Exception:
        return "#EF8A22"
...
def _cmd_show(args: argparse.Namespace) -> int:
    ...
    if not payload.get("nodes"):
        console.print(
            "[grey62]No learning yet — use Robo a while and your learned skills and "
...
if __name__ == "__main__":
    _p = argparse.ArgumentParser(prog="robo journey")
    register_cli(_p)
    _a = _p.parse_args()
    sys.exit(_a.func(_a))
