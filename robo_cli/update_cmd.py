...
def _update_via_zip(args):
    ...
    if branch != "main":
        ...
        _m().sys.exit(1)
    zip_url = (
        f"https://github.com/IgniteeNow/Robo/archive/refs/heads/{branch}.zip"
    )
    ...
    try:
        ...
        print(
            ...
            "reinstall from https://github.com/IgniteeNow/Robo"
        )
        _m().sys.exit(1)
    finally:
...
OFFICIAL_REPO_URLS = {
    "https://github.com/IgniteeNow/Robo.git",
    "git@github.com:IgniteeNow/Robo.git",
    "https://github.com/IgniteeNow/Robo",
    "git@github.com:IgniteeNow/Robo",
}

OFFICIAL_REPO_URL = "https://github.com/IgniteeNow/Robo.git"
...
def _sync_with_upstream_if_needed(git_cmd: list[str], cwd: Path) -> None:
    ...
    if not has_upstream:
        ...
        print("  This means you may miss updates from IgniteeNow/Robo.")
        print()
        try:
            response = (
        ...
        if response in {"", "y", "yes"}:
            ...
            if _add_upstream_remote(git_cmd, cwd):
                print(
                    "  ✓ Added upstream: https://github.com/IgniteeNow/Robo.git"
                )
                has_upstream = True
            else:
            ...
            print(
                "  Skipped. Run 'git remote add upstream https://github.com/IgniteeNow/Robo.git' to add later."
            )
...
def _cmd_update_impl(args, gateway_mode: bool):
    ...
    try:
        ...
        if not import_ok:
            ...
            print("    https://github.com/IgniteeNow/Robo")
