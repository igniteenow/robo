"""Relay subscriber for the persisted Robo shared-metrics slice."""
...
class SharedMetricsSubscriber:
    """Persist validated Robo counters from Relay lifecycle events."""
    ...
    def __call__(self, event: Any) -> None:
        ...
        with self._lock:
            ...
            try:
                ...
                logger.warning(
                    "Unable to persist the Robo shared metric: %s",
                    metric_name,
                    exc_info=True,
                )
