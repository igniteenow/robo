...
def _profile_user_agent() -> str:
    """Return a ``robo-cli/<version>`` UA string, with a stable fallback.
    ...
    """
    try:
        from robo_cli import __version__ as _ver  # lazy: avoid layer cycle at import time
        return f"robo-cli/{_ver}"
    except Exception:
        return "robo-cli"
...
class ProviderProfile:
    ...
    def fetch_models(
        ...
        *,
        ...
        # robo-cli UA so the catalog endpoint is reachable.
