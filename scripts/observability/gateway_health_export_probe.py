...
def main() -> None:
    ...
    robo_home = Path(tempfile.mkdtemp(prefix="robo-otel-smoke-"))
    ...
    config = {
        "monitoring": {
            ...
            "gateway_health_export": {
                ...
                "resource_attributes": {
                    "service.name": "robo-gateway-smoke",
    ...
    print(json.dumps({"robo_home": str(robo_home), "requests": len(rows), "paths": sorted(paths)}, indent=2))
