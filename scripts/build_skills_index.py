#!/usr/bin/env python3
"""Build the Robo Skills Index — a centralized JSON catalog of all skills.
...
`robo skills search/install` can use it without hitting the GitHub API.
...
# Ensure ROBO_HOME is set (needed by tools/skills_hub.py imports)
...
def main():
    print("Building Robo Skills Index...", flush=True)
