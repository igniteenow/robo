#!/usr/bin/env python3
"""Summarize micro-compaction telemetry from Robo logs.
...
With no LOGFILE, reads ``$ROBO_HOME/logs/agent.log`` (default ~/.robo).
...
def default_log() -> Path:
    home = os.environ.get("ROBO_HOME") or str(Path.home() / ".robo")
