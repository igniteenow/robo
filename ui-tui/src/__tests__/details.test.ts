...
describe('sectionMode', () => {
  ...
  it('keeps thinking + tools collapsed (click-to-expand) by default', () => {
    // Claude-Code-style: one summary row per section while the agent works;
    // the persisted global mode does not force them open or hidden.
