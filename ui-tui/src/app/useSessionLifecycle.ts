...
import type { ScrollBoxHandle } from '@robo/ink'
import { evictInkCaches } from '@robo/ink'
...
export const writeActiveSessionFile = (sessionId: null | string, file = process.env.ROBO_TUI_ACTIVE_SESSION_FILE) => {
  if (!file || !sessionId) {
    return
  }
