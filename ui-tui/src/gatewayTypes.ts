import type { BillingBlock, UsageModelData } from '@robo/shared/billing'
import type { RoboSkin } from '@robo/shared/skin'

import type { SessionInfo, SlashCategory, SubagentStatus, Usage } from './types.js'

/** The cross-surface skin contract (canonical shape in `@robo/shared`).
 *  Includes the paired light_colors/dark_colors overlays from #20379. */
export type GatewaySkin = RoboSkin
...
// Wire shapes now live in @robo/shared for reuse by TypeScript clients.
export type {
  BillingAutoReload,
  BillingBlock,
  BillingCardInfo,
