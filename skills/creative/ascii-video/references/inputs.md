...
Common fixes:
- Brand names: spell phonetically ("Robo" -> "Roh Boh", "nginx" -> "engine-x")
...
QUOTES = [
    ("Say hey Robo and it just starts working.\nNo tabs, no copy-paste,\njust the result.", "Early beta tester"),
]

# TTS text: flat, phonetically corrected for speech
QUOTES_TTS = [
    "Say hey Roh Boh and it just starts working. No tabs, no copy paste, just the result.",
]
