/**
 * Robo desktop plugin template. Save as:
 *   <robo home>/desktop-plugins/<id>/plugin.js   (folder name == id)
 * where <robo home> is ~/.robo by default, or ~/.robo/profiles/<name>
 * when running a named profile (`robo -p <name>`). Run `robo doctor` (or
 ...
 * Only these imports resolve: @robo/plugin-sdk, react, react/jsx-runtime.
 */

import { cn, haptic, host, Tip, usePluginI18n, useValue } from '@robo/plugin-sdk'
