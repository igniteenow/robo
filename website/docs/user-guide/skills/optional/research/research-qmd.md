...
| | |
|---|---|
| Source | Optional — install with `robo skills install official/research/qmd` |
...
| Related skills | [`obsidian`](/docs/user-guide/skills/bundled/note-taking/note-taking-obsidian), [`robo-engineer`](/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-robo-engineer), [`arxiv`](/docs/user-guide/skills/bundled/research/research-arxiv) |
...
Robo Agent via the native MCP client. This is the preferred
...
Then configure Robo Agent to connect via HTTP:
