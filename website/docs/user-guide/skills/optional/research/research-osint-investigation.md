...
| | |
|---|---|
| Source | Optional — install with `robo skills install official/research/osint-investigation` |
| Path | `optional-skills/research/osint-investigation` |
| Version | `0.1.0` |
| Author | Robo Agent (adapted from ShinMegamiBoson/OpenPlanter, MIT) |
...
# $ROBO_OSINT_CACHE/icij/ (default: ~/.cache/robo-osint/icij/).
...
# Set ROBO_OSINT_UA=your-app/1.0 (your@email) to identify yourself
