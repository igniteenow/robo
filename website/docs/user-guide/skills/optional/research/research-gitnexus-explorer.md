...
| | |
|---|---|
| Source | Optional — install with `robo skills install official/research/gitnexus-explorer` |
...
| Related skills | [`robo-engineer`](/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-robo-engineer), [`codebase-inspection`](/docs/user-guide/skills/bundled/github/github-codebase-inspection) |
...
- **The web UI does NOT create `.claude/` or `CLAUDE.md`.** Those are created by
  ...
  robo-engineer users don't need.
