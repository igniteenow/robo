...
| | |
|---|---|
| Source | Optional — install with `robo skills install official/data-science/jupyter-notebook` |
...
| `execute_code` | One-shot scripts needing robo tool access (web_search, file ops). Stateless. |
