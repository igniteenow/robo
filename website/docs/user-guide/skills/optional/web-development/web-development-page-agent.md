...
| | |
|---|---|
| Source | Optional — install with `robo skills install official/web-development/page-agent` |
...
- User wants **Robo itself to drive a browser** → use Robo' built-in browser tool (Browserbase / Camofox). page-agent is the *opposite* direction.
