...
| | |
|---|---|
| Source | Optional — install with `robo skills install official/health/neuroskill-bci` |
...
Connect Robo to a running [NeuroSkill](https://neuroskill.com/) instance to read
