...
| | |
|---|---|
| Source | Optional — install with `robo skills install official/finance/stocks` |
| Path | `optional-skills/finance/stocks` |
| Version | `0.1.0` |
| Author | Mibay (Mibayy), Robo Agent |
| License | MIT |
...
```
SCRIPT=~/.robo/skills/finance/stocks/scripts/stocks_client.py
...
```
python3 ~/.robo/skills/finance/stocks/scripts/stocks_client.py quote AAPL
```
