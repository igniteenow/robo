...
| | |
|---|---|
| Source | Optional — install with `robo skills install official/blockchain/hyperliquid` |
| Path | `optional-skills/blockchain/hyperliquid` |
| Version | `0.1.0` |
| Author | Hugo Sequier (Hugo-SEQUIER), Robo Agent |
| License | MIT |
...
The script reads `${ROBO_HOME:-~/.robo}/.env` for two optional defaults:
...
Helper script: `~/.robo/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py`
...
```bash
python3 ~/.robo/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py <command> [args]
```
...
optional when `HYPERLIQUID_USER_ADDRESS` is set in `${ROBO_HOME:-~/.robo}/.env`.
...
```bash
python3 ~/.robo/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py dexs

python3 ~/.robo/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py \
