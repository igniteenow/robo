...
| | |
|---|---|
| Source | Optional — install with `robo skills install official/gaming/pokemon-player` |
...
The repo is IgniteeNow/pokemon-agent on GitHub. Clone it, then
...
On this machine it is already set up at /home/robodev/pokemon-agent
