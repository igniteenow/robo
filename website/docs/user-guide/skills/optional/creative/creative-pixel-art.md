...
| | |
|---|---|
| Source | Optional — install with `robo skills install official/creative/pixel-art` |
...
```python
import sys
sys.path.insert(0, "/home/robodev/.robo/skills/creative/pixel-art/scripts")
...
```bash
cd /home/robodev/.robo/skills/creative/pixel-art/scripts
...
- ffmpeg on PATH (only needed for video — Robo installs package this)
