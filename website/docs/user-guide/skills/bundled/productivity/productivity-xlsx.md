...
For full investment-banking conventions (balance checks, sensitivity tables, named ranges), install the optional skill: `robo skills install official/finance/excel-author`.
