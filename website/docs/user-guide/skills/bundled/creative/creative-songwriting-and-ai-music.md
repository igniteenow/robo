...
- "Robo" -> "Roh Boh" (forces correct pronunciation)
...
- **heartmula** — full songs with vocals from lyrics + tags
  ...
  `robo skills install official/creative/heartmula`
- **audiocraft** — Meta's MusicGen (instrumental text-to-music) and
  AudioGen (sound effects):
  `robo skills install official/creative/audiocraft-audio-generation`
