...
This skill exists so Robo can make **cool demos** with it — the kind people post to X. See `pretext.cool` and `chenglou.me/pretext` for the community demo corpus.
...
See `templates/hello-orb-flow.html` for a working single-file starter.
