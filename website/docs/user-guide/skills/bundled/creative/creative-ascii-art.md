...
```bash
python3 -m pyfiglet "ROBO" -f slant | boxes -d stone
# Or without pyfiglet installed:
curl -s "https://asciified.thelicato.io/api/v2/ascii?text=ROBO&font=Slant" | boxes -d stone
```
