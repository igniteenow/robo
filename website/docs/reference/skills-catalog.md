...
| [`robo-engineer`](/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-robo-engineer) | Use, configure, theme, extend, and orchestrate Robo Agent. | `autonomous-ai-agents/robo-engineer` |
...
| [`robo-engineer-skill-authoring`](/docs/user-guide/skills/bundled/software-development/software-development-robo-engineer-skill-authoring) | Author in-repo SKILL.md files: frontmatter and structure. | `software-development/robo-engineer-skill-authoring` |
| [`inspecting-robo-desktop-dom`](/docs/user-guide/skills/bundled/software-development/software-development-inspecting-robo-desktop-dom) | Read the live Robo desktop DOM/CSS over CDP. | `software-development/inspecting-robo-desktop-dom` |
...
| [`plan`](/docs/user-guide/skills/bundled/software-development/software-development-plan) | Write a markdown plan to .robo/plans/; no execution. | `software-development/plan` |
