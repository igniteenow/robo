...
| [**honcho**](/docs/user-guide/skills/optional/autonomous-ai-agents/autonomous-ai-agents-honcho) | Configure and troubleshoot Honcho memory for Robo. |
...
| [**robo-s6-container-supervision**](/docs/user-guide/skills/optional/devops/devops-robo-s6-container-supervision) | Modify or debug s6 services in the Robo Docker image. |
