...
sidebar_position: 4
title: "Contributing"
description: "How to contribute to Robo Agent — dev setup, code style, PR process"
---

# Contributing

Thank you for contributing to Robo Agent! This guide covers setting up your dev environment, understanding the codebase, and getting your PR merged.
...
- Building a custom/local tool without modifying Robo core? Start with [Build a Robo Plugin](../developer-guide/plugins/index.md)
- Building a new built-in core tool for Robo itself? Start with [Adding Tools](./adding-tools.md)
...
You can also run a fully isolated Robo instance (throwaway ROBO_HOME, separate Electron
userData, distinct Electron app name to avoid the single-instance lock):

```bash
scripts/dev-sandbox.sh python -m robo_cli.main
scripts/dev-sandbox.sh --persistent python -m robo_cli.main desktop  # state survives restarts, but lives in the worktree :)
```
...
echo 'OPENROUTER_API_KEY=sk-or-v1-your-key' >> ~/.robo/.env
```
...
- **Profile-safe paths**: Never hardcode `~/.robo` — use `get_robo_home()` from `robo_constants` for code paths and `display_robo_home()` for user-facing messages. See [AGENTS.md](https://github.com/IgniteeNow/robo-engineer/blob/main/AGENTS.md#profiles-multi-instance-support) for full rules.
...
- **Discord**: [GitHub Discussions](https://github.com/IgniteeNow/robo-engineer/discussions)
- **GitHub Discussions**: For design proposals and architecture discussions
- **Skills Hub**: Upload specialized skills and share with the community

## License

By contributing, you agree that your contributions will be licensed under the [MIT License](https://github.com/IgniteeNow/robo-engineer/blob/main/LICENSE).
