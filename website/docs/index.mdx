...
slug: /
sidebar_position: 0
title: "Robo Agent Documentation"
description: "The self-improving AI agent with a built-in learning loop. It creates skills from experience, improves them during use, and remembers across sessions."
...
>
  ...
  <a
    href="https://github.com/IgniteeNow/robo-engineer/tree/main/website/docs"
    style={{
      display: "inline-block",
      padding: "0.6rem 1.2rem",
...
After installing, run `robo setup` — pick a provider (OpenRouter, Anthropic, OpenAI, xAI, and more), authenticate, and you're ready to chat.
:::
...
| 🔌 **[MCP Integration](/user-guide/features/mcp)**                      | Connect to MCP servers, filter their tools, and extend Robo safely  |
| 🧭 **[Use MCP with Robo](/guides/use-mcp-with-robo)**               | Practical MCP setup patterns, examples, and tutorials                 |
| 🎙️ **[Voice Mode](/user-guide/features/voice-mode)**                    | Real-time voice interaction in CLI, Telegram, Discord, and Discord VC |
| 🗣️ **[Use Voice Mode with Robo](/guides/use-voice-mode-with-robo)** | Hands-on setup and usage patterns for Robo voice workflows          |
| 🎭 **[Personality & SOUL.md](/user-guide/features/personality)**        | Define Robo' default voice with a global SOUL.md                    |
...
| 💡 **[Tips & Best Practices](/guides/tips)**                            | Quick wins to get the most out of Robo                              |
...
- **Provider-agnostic** — Works with [OpenRouter](https://openrouter.ai), Anthropic, OpenAI, xAI, and any OpenAI-compatible endpoint
...
- **Full web control** — Search, extract, browse, vision, image generation, TTS, each configurable with your own provider keys
