...
const config: Config = {
  title: 'Robo',
  tagline: 'The AI security engineer that lives on your desktop — by Ignitee Now',
  favicon: 'img/favicon.ico',

  url: 'https://robo.igniteenow.com',
  baseUrl: '/docs/',

  organizationName: 'IgniteeNow',
  projectName: 'robo-engineer',
      ...
      '@docusaurus/plugin-client-redirects',
      {
        ...
        redirects: [
          ...
          },
          {
            ...
            from: '/guides/build-a-robo-plugin',
    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl: 'https://github.com/IgniteeNow/robo-engineer/edit/main/website/',
        },
        blog: false,
        theme: {
  ...
  themeConfig: {
    image: 'img/robo-engineer-banner.png',
    colorMode: {
      defaultMode: 'dark',
    ...
    navbar: {
      ...
      items: [
        ...
        {
          href: 'https://github.com/IgniteeNow/robo-engineer/discussions',
          label: 'Discord',
          position: 'right',
        },
      ],
    ...
    footer: {
      ...
      links: [
        ...
        },
        {
          title: 'Community',
          items: [
            { label: 'Discord', href: 'https://github.com/IgniteeNow/robo-engineer/discussions' },
            { label: 'GitHub Issues', href: 'https://github.com/IgniteeNow/robo-engineer/issues' },
        ...
        },
        {
          ...
          items: [
            ...
            { label: 'GitHub', href: 'https://github.com/IgniteeNow/robo-engineer' },
            { label: 'Ignitee Now', href: 'https://igniteenow.com' },
          ],
        },
      ],
      copyright: `Built by <a href="https://igniteenow.com">Ignitee Now</a> · MIT License · ${new Date().getFullYear()}`,
    },
    prism: {
