  ...
  return (
    <div className={styles.wrap}>
      <div className={styles.hero}>
        ...
        <p>
          What people are building with Robo. Every tile links to the
          original post, issue, video, or gist where someone describes how
          they use Robo. Stories are only listed here with the author&apos;s
          own words, unedited, and a link back to the source.
        </p>
        {allStories.length > 0 && (
      ...
      {visible.length === 0 ? (
        <div className={styles.empty}>
          {allStories.length === 0
            ? 'No stories yet. Robo is new, so yours could be the first one here.'
      ...
      <div className={styles.footer}>
        ...
        <a
          href="https://github.com/IgniteeNow/robo-engineer/edit/main/website/src/data/userStories.json"
          target="_blank"
          rel="noopener noreferrer"
        >
        ...
        <a href="https://github.com/IgniteeNow/robo-engineer/discussions" target="_blank" rel="noopener noreferrer">
          GitHub Discussions
        </a>{' '}
