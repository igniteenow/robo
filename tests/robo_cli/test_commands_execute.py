...
Every ``CommandDef`` with ``execute`` set must:
  * name a key that exists in :data:`robo_cli.slash_exec.EXECUTORS`, and
...
from robo_cli.commands import COMMAND_REGISTRY, resolve_command
from robo_cli.slash_exec import (
    EXECUTORS,
    CommandContext,
    CommandReply,
    execute_command,
