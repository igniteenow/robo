"""Tests for `robo secrets bitwarden token` / `robo secrets onepassword token`.
...
from robo_cli import onepassword_secrets_cli as op_cli
from robo_cli import secrets_cli as bw_cli
