...
# parents[2] is the repo root; parents[1] would be tests/, whose tests/agent
# package then shadows the real ``agent`` package for every later import.
...
class TestHostHeaderValidator:
    ...
    def test_zero_zero_bind_accepts_anything(self):
        ...
        from robo_cli.web_server import _is_accepted_host
