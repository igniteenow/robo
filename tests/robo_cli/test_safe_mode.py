"""Tests for `robo chat --safe-mode` isolation."""
...
_VARS = ("ROBO_SAFE_MODE", "ROBO_IGNORE_USER_CONFIG", "ROBO_IGNORE_RULES")
...
def test_cmd_chat_safe_mode_sets_env_before_startup(monkeypatch):
    ...
    def fake_has_provider() -> bool:
        assert os.environ["ROBO_SAFE_MODE"] == "1"
        assert os.environ["ROBO_IGNORE_USER_CONFIG"] == "1"
        assert os.environ["ROBO_IGNORE_RULES"] == "1"
        return True
