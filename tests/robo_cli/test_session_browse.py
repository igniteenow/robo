"""Tests for the interactive session browser (`robo sessions browse`).
...
from robo_cli.main import _session_browse_picker
...
class TestSessionBrowseArgparse:
    ...
    def test_browse_subcommand_exists(self):
        """robo sessions browse should be parseable."""
