"""Tests for the specifier module + `robo kanban specify` CLI surface.
...
from robo_cli import kanban as kanban_cli
...
def _run_cli(*argv: str) -> int:
    """Invoke the `robo kanban …` argparse surface directly."""
