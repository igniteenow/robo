"""Tests for ``robo approvals suggest`` (robo_cli/approvals_suggest.py).

Approval history in Robo is implied, not ledgered: the session DB
...
from robo_cli.approvals_suggest import (
    Proposal,
    apply_proposals,
    build_proposals,
    derive_glob,
