...
def test_vertex_registered_in_provider_registry():
    """PROVIDER_REGISTRY (robo_cli.auth) is what agent/auxiliary_client.py's
...
def test_vertex_registered_in_robo_overlays():
    """robo_cli.providers.get_provider("vertex") backs
