...
class TestGetCopilotModelContext:
    ...
    @patch("robo_cli.models.fetch_github_model_catalog", return_value=_SAMPLE_CATALOG)
    ...
    @patch("robo_cli.models._urlopen_model_catalog_request")
    ...
    @patch("robo_cli.models.fetch_github_model_catalog", return_value=[])
