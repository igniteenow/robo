...
The main() function in robo_cli/main.py sets subparsers.required=True
...
If the subcommand token is consumed as a flag value (e.g. `robo -c model`
...
def _build_parser():
    """Build a minimal replica of the robo top-level parser."""
