...
Guards the residual site missed by the 49fa04a23/346e5673d threadpool
migration: POST /api/cron/blueprints/instantiate (_call_cron_for_profile
create_job). The stub asserts it is running OFF the event loop thread by
checking that no running asyncio loop is present in its thread.
"""
