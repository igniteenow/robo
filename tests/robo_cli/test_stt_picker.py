"""Tests for the Speech-to-Text category in `robo tools` (tools_config).
...
from robo_cli.tools_config import (  # noqa: E402
    ...
    def test_apply_provider_selection_stt(self):
        ...
        with patch(
            ...
            feats.return_value = MagicMock(
                igniteenow_auth_present=False, account_info=None
            )
...
class TestModelPicker:
    ...
    def test_configure_stt_model_defaults_to_current(self):
        ...
        with patch(
            "robo_cli.tools_config._prompt_choice", return_value=0
        ) as pc:
...
class TestPostSetup:
    def test_faster_whisper_in_post_setup_ready(self):
        from robo_cli.tools_config import _POST_SETUP_READY
