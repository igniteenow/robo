"""Unit tests for robo_cli.managed_scope (resolver + loaders + key helpers)."""
import textwrap
...
def test_managed_dir_env_scrubbed_by_default():
    """conftest must scrub ROBO_MANAGED_DIR so a dev-shell value can't leak in."""
    import os

    assert "ROBO_MANAGED_DIR" not in os.environ
