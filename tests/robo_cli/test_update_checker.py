...
class TestRemoteUrls:
    @pytest.mark.parametrize("url", [
        "https://github.com/IgniteeNow/robo-engineer.git", "https://github.com/igniteenow/robo-engineer",
        "https://github.com/IgniteeNow/robo-engineer/", "git@github.com:IgniteeNow/robo-engineer.git",
        "ssh://git@github.com/IgniteeNow/robo-engineer.git", "ssh://git@github.com:22/IgniteeNow/robo-engineer",
        "https://user:s3cr3t-token@github.com/IgniteeNow/robo-engineer.git", "  git://github.com/IgniteeNow/Robo-Engineer.git  ",
    ])
    def test_every_spelling_of_the_official_repo_is_recognised(self, url):
        assert banner._canonical_github_remote(url) == "github.com/igniteenow/robo-engineer"
    ...
    def test_only_ignitee_nows_repo_is_official(self):
        assert banner._is_official_ssh_remote("git@github.com:IgniteeNow/robo-engineer.git")
        assert not banner._is_official_ssh_remote("git@github.com:someone/robo-engineer.git")
        assert not banner._is_official_ssh_remote("https://github.com/IgniteeNow/robo-engineer.git")  # not SSH
        assert not banner._is_official_ssh_remote("git@github.com.evil.test:IgniteeNow/robo-engineer.git")
...
class TestSshRemotesAreNeverFetched:
    ...
    def test_the_official_repo_over_ssh_is_fetched_over_https_instead(self, world, monkeypatch):
        ...
        world.publish("d", "e")
        result, seen = self._calls(world, "git@github.com:IgniteeNow/robo-engineer.git")
...
class TestBannerFacts:
    ...
    def test_release_tag_links_only_for_the_official_repo(self, world, monkeypatch):
        ...
        monkeypatch.setattr(banner, "_latest_release_cache", None)
        git(world.clone, "remote", "set-url", "origin", "https://github.com/IgniteeNow/robo-engineer.git")
        assert banner.get_latest_release_tag(world.clone) == ("v3.0.0", "https://github.com/IgniteeNow/robo-engineer/releases/tag/v3.0.0")
