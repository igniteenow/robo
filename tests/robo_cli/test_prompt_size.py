"""Tests for the ``robo prompt-size`` diagnostic (issue #34667)."""
...
from robo_cli.prompt_size import (
    _SKILLS_BLOCK_RE,
...
def _seed_memory(robo_home, memory_text="", user_text=""):
    mem_dir = robo_home / "memories"
...
def _seed_skill(robo_home, name, description):
    skill_dir = robo_home / "skills" / "demo" / name
