...
The cache exists to keep `robo tools` → "All Platforms" fast: every
...
def test_remove_env_value_invalidates_cache(tmp_path, monkeypatch):
    ...
    from robo_cli import config as config_mod
    ...
    monkeypatch.setattr(config_mod, "ensure_robo_home", lambda: None)
