...
the shared /blueprint command handler (robo_cli/blueprint_cmd.py), and
the docs generator. Uses an isolated ROBO_HOME for anything that touches the
cron job store.
"""
...
class TestRenderers:
    ...
    def test_deeplink_shape(self):
        ...
        assert url.startswith("robo://blueprint/morning-brief?")
