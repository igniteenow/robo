...
manipulation. Robo keeps canonical conversation history in state.db and may
...
def fake_homes(tmp_path, monkeypatch):
    """Point ROBO_HOME at a temp profile dir.

    Uses the real env-var resolution chain (get_robo_home /
    get_default_robo_root) instead of monkeypatching private helpers —
    ...
    ROBO_HOME=<root>/profiles/<name> makes get_default_robo_root()
