...
Damien's incident (Discord, 2026-05-28): a long Robo session in a Discord
...
def _make_legacy_session_db_class() -> type:
    ...
    imports the same still-loaded ``robo_state`` module, whose ``SessionDB``
...
_NominalSessionDBImpostor.__module__ = "robo_state"
