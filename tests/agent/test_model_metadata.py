...
class TestDefaultContextLengths:
    ...
    def test_deepseek_v4_models_1m_context(self):
        ...
        # / Ignitee Now Portal) to 1M without probing down to the legacy 128K
...
# =========================================================================
# Ignitee Now Portal context-window resolution (provider="igniteenow")
# =========================================================================

class TestIgniteeNowPortalContextResolution:
    """Ignitee Now Portal /v1/models is authoritative for what Ignitee Now infra enforces
    ...
    def test_stale_cache_is_bypassed_and_overwritten_by_portal(
        ...
        """Users upgrading from pre-fix builds have ``qwen3.6-plus@…igniteenow… =
