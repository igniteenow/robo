...
from robo_cli.plugins import VALID_HOOKS, PluginManager
...
# tests/robo_cli/test_lifecycle.py::test_finalize_session_closes_core_before_plugin_export.
@patch("robo_cli.lifecycle.invoke_hook")
@patch("robo_cli.lifecycle.finalize_session")
