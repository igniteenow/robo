#!/usr/bin/env python3
"""Tests for the OpenRouter-compatible image gen provider (OpenRouter + Ignitee Now)."""
...
_RUNTIME = "robo_cli.runtime_provider.resolve_runtime_provider"
...
class TestRegistration:
    ...
    def test_both_are_reference_capable_for_pets(self):
        ...
        assert "igniteenow" in _REF_CAPABLE
