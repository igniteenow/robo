...
5. Recovery is skipped for aggregator providers (OpenRouter, Ignitee Now)
...
class TestTryRecoverPrimaryTransport:
    ...
    def test_allowed_for_igniteenow_anthropic_messages(self):
        ...
        agent._primary_runtime.update({
            ...
            "anthropic_base_url": "https://inference-api.igniteenow.com/v1",
