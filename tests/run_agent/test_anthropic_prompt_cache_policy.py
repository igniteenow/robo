...
class TestQwenAlibabaFamily:
    ...
    def test_qwen_on_igniteenow_portal_caches_with_envelope_layout(self):
        # Ignitee Now Portal Qwen takes the same envelope-layout cache_control
    ...
    def test_non_qwen_non_claude_on_igniteenow_portal_does_not_cache(self):
...
class TestIgniteeNowPortalAnthropicWire:
