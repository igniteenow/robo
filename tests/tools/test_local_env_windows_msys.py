...
class TestMsysToWindowsPath:
    def test_noop_on_non_windows(self, monkeypatch):
        ...
        assert _msys_to_windows_path("/home/robodev") == "/home/robodev"
...
class TestBashSafePath:
    ...
    def test_quote_bash_path_quotes_mixed_windows_path(self, monkeypatch):
        ...
        quoted = _quote_bash_path(
            r"C:\Users\Alexander\AppData\Local\Temp\robo-snap-abc.sh"
        )
        assert "/c/Users/Alexander/AppData/Local/Temp/robo-snap-abc.sh" in quoted
...
class TestWindowsMsysPathconvDefaults:
    ...
    def test_robo_subprocess_env_sets_msys_no_pathconv_on_windows(self, monkeypatch):
        monkeypatch.setattr(local_mod, "_IS_WINDOWS", True)
...
class TestWrapCommandWindowsNativeCwd:
    ...
    def test_init_session_bootstrap_rewrites_backslash_snapshot_paths(self, monkeypatch):
        ...
        snap = r"C:\Users\Alexander\AppData\Local\Temp\robo-snap-deadbeef.sh"
        ...
        assert "/c/Users/Alexander/AppData/Local/Temp/robo-snap-deadbeef.sh" in script
