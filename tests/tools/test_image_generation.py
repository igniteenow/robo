...
class TestGptQualityPinnedToMedium:
    ...
    and cannot be overridden via config. Pinning keeps Ignitee Now Portal billing
...
class TestManagedKreaRouting:
    ...
    def test_routes_native_krea_model_to_krea_plugin_in_managed_mode(
        ...
        monkeypatch.setattr(
            "robo_cli.plugins._ensure_plugins_discovered", lambda *a, **k: None
        )
