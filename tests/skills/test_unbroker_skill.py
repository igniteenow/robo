...
# Resolve the skill's scripts dir across layouts: standalone dev repo (tests/) and robo-engineer
...
_CANDIDATES = [
    ...
    _HERE.parent.parent.parent.joinpath(*_REL),          # robo-engineer (tests/skills/)
]
