"""Tests for _setup_feishu() in robo_cli/gateway.py.
...
def _run_setup_feishu(
    *,
    ...
    with patch("robo_cli.config.save_env_value", side_effect=mock_save), \
         patch("robo_cli.config.get_env_value", side_effect=mock_get), \
         patch("robo_cli.config.remove_env_value", side_effect=mock_remove), \
         patch("robo_cli.cli_output.prompt_yes_no", side_effect=prompt_yes_no_responses), \
         patch("robo_cli.setup.prompt_choice", side_effect=prompt_choice_responses), \
         patch("robo_cli.cli_output.prompt", side_effect=prompt_responses), \
         patch("robo_cli.cli_output.print_header"), \
         patch("robo_cli.cli_output.print_info"), \
         patch("robo_cli.cli_output.print_success"), \
         patch("robo_cli.cli_output.print_warning"), \
         patch("robo_cli.cli_output.print_error"), \
