...
def test_load_transcript_returns_db_messages_when_no_jsonl(tmp_path, monkeypatch):
    ...
    ~/.robo/state.db. (DEFAULT_DB_PATH is a module-level constant computed
    at robo_state import time, before pytest's ROBO_HOME monkeypatch
    fires — the autouse fixture's ROBO_HOME override doesn't help here.)
    """
    import robo_state
