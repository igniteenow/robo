...
The unit tests in tests/robo_cli/test_service_manager.py exercise the
...
docstring. ``/run/service`` is chowned robo-writable by the
...
_REGISTER_SCRIPT = """
import sys
sys.path.insert(0, "/opt/robo")
from robo_cli.service_manager import S6ServiceManager
