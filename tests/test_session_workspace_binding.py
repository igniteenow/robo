"""Session <-> workspace grouping key (robo_state.workspace_key).

The key is what `robo sessions list --workspace` groups/filters on. It is a
...
from robo_state import workspace_key
