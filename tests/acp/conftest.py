...
Keeps the ACP server tests offline: ``RoboACPAgent._build_model_state``
calls ``robo_cli.inventory.build_models_payload``, which (without this
...
def _offline_model_inventory(monkeypatch):
    ...
    import robo_cli.inventory as inventory
