...
def worker_loop(worker_id: int, robo_home: str, result_file: str) -> None:
...
def reclaimer_loop(robo_home: str, result_file: str) -> None:
...
def main():
    home = tempfile.mkdtemp(prefix="robo_mixed_stress_")
    print(f"ROBO_HOME = {home}")
